...
#checkpoint_file='/shared/mrfil-data/cddunca2/brats2020/models/checkpoints/checkpoint-25.pt'
#checkpoint_file='/shared/mrfil-data/cddunca2/brats2020/models/checkpoints/checkpoint-50.pt'

checkpoint_file='/shared/mrfil-data/cddunca2/gliomaseg/debug/checkpoints/checkpoint-50.pt'
...
annotations_dir = '/shared/mrfil-data/cddunca2/annotations/debug-overfit/'
...
with torch.no_grad():
  ...
  for src, tgt in tqdm(dataloader):
    ...
    #tgt = nib.Nifti1Image(tgt.squeeze()[1, :, :, :].numpy(), np.eye(4))
    #tgt.to_filename(os.path.join(annotations_dir, 'ground_truth.nii.gz'))
